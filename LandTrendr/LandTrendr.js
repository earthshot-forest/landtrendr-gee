...
var buildSensorYearCollection = buildSensorYearCollection
...
var runLT = function(startYear, endYear, startDay, endDay, aoi, index, ftvList, runParams, maskThese, exclude){
  maskThese = (typeof maskThese !== 'undefined') ?  maskThese : ['cloud','shadow','snow'];
  exclude = (typeof exclude !== 'undefined') ?  exclude : {}; // default to not exclude any images
...
var mapRGBcomposite = function(index, startYear, endYear, startDay, endDay, redYear, greenYear, blueYear, aoi, runParams, nStdev, maskThese, exclude){
  maskThese = (typeof maskThese !== 'undefined') ?  maskThese : ['cloud','shadow','snow'];
  exclude = (typeof exclude !== 'undefined') ?  exclude : {}; // default to not exclude any images
...
var timesyncLegacyStack = function(startYear, endYear, startDay, endDay, aoi, maskThese, exclude){
  exclude = (typeof exclude !== 'undefined') ?  exclude : {}; // default to not exclude any images
...
var ltPixelTimeSeriesArray = function(lt, pixel, indexFlip){
...
var getParams = function(paramPanel){
...
var getIndexSelect = function(indexSelectPanel){
  return indexSelectPanel.widgets().get(1).getValue();
};

// MASK PANEL
var maskSelectPanel = function(){
...
var getMaskSelect = function(maskSelectPanel){
  var selectionBoo = [
...
var getDays = function(datePanel){
  return {
...
var getBuffer = function(bufferPanel){
...
var getChangeMap = function(lt, changeParams){
  // changeParams
  /*
  {
    delta:  'Loss',
...
module.exports = {runLT, getChangeMap}